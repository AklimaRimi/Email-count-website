...
dept = driver.find_element(By.XPATH,'//*[@id="criteres_de_selections"]/div/div[2]/div[7]/div/span/span[1]/span/ul/li/input').click()
...
for i in range(0,16):
    ...
    data.append(['Workforce',text,email_count.text,price])
    uncheck = driver.find_element(By.XPATH,'//*[@id="criteres_de_selections"]/div/div[2]/div[7]/div/span/span[1]/span/ul/li[1]/span').click()
    
data = pd.DataFrame(data,columns=['Type','Cat','Email_count','Price'])
data.to_csv('Workforce.csv',index=False)
