...
dept = driver.find_element(By.XPATH,'//*[@id="criteres_de_selections"]/div/div[2]/div[8]/div/span/span[1]/span/ul/li/input').click()
...
for i in range(0,3):
    ...
    data.append(['Categories',text,email_count.text,price])
    uncheck = driver.find_element(By.XPATH,'//*[@id="criteres_de_selections"]/div/div[2]/div[8]/div/span/span[1]/span/ul/li[1]/span').click()
