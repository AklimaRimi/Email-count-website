...
dept = driver.find_element(By.XPATH,'//*[@id="criteres_de_selections"]/div/div[2]/div[9]/div/span/span[1]/span/ul/li/input').click()
...
for i in range(0,11):
    ...
    data.append(['Legal Form',text,email_count.text,price])
    uncheck = driver.find_element(By.XPATH,'//*[@id="criteres_de_selections"]/div/div[2]/div[9]/div/span/span[1]/span/ul/li[1]/span').click()
    
data = pd.DataFrame(data,columns=['Type','Cat','Email_count','Price'])
data.to_csv('Form.csv',index=False)
